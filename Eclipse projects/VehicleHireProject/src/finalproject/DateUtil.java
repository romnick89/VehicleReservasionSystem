...
public class DateUtil
{
   ...
   /**
    * Set the long pattern of dates
    */
   public void setlongDatePattern(String longPattern) 
   {
	   longDatePattern = longPattern;
   }
   
   /**
    * Set the short pattern of dates
    */
   public void setshortDatePattern(String shortPattern) 
   {
	   shortDatePattern = shortPattern; 
   }
